...
public class CorridorFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    private void CorridorFirstGeneration()
    {
        ...
        // potentialRoomPositions와 deadEnds가 방의 센터들임
        var roomCenters = new HashSet<Vector2Int>(potentialRoomPositions);
        foreach (var deadEnd in deadEnds) roomCenters.Add(deadEnd);

        var (start, exit) = ProceduralGenerationAlgorithms.GetLongestPathPoints(floorPositions, roomCenters);
